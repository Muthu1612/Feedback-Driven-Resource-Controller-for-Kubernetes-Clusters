...
job_delay = 15  # number of seconds that we believe a the CPU is changed after a job is started
read_jobs_flag = False  # if read a job from a file and render the jobs
# global variables
